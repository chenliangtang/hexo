...
function lazyImage(args) {
  ...
  var image = ['<span itemprop="image" itemscope itemtype="http://schema.org/ImageObject"><img itemprop="url image" src="/source/images/loading.gif" data-original="' + src + '" class="full-image"'];
